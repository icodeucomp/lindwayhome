...
export const fabricsLists = [
  ...
  {
    name: "Cotton Viscose",
    description: "A breathable blend that combines the softness of cotton with the graceful drape of viscose. Light, comfortable, and easy to wear—ideal for everyday pieces with a polished finish.",
  },
  {
    name: "Sifon",
    description:
